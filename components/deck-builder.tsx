...
export default function DeckBuilder({ selectedFaction, onBackToFactionSelection }: DeckBuilderProps) {
  ...
  return (
    <>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              {validation?.isValid && (
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 text-white font-black hover:shadow-lg hover:shadow-violet-500/30 transition-all duration-300 cursor-pointer mt-4 uppercase tracking-widest"
      ...
      <DifficultyModal isOpen={showDifficultyModal} onClose={() => setShowDifficultyModal(false)} />
      <style jsx global>{`
